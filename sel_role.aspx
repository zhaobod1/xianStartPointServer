<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sel_role.aspx.cs" Inherits="sel_org" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#btn_save").click(function() {
                if (sel_data_pk == "") { Popalert("请选择角色！"); return false; }
                parent.set_role(sel_data_pk);
                parent.closePop();
            });
        ...
        function onClick(event, treeId, treeNode, clickFlag) {
            ...
            sel_data_pk = "{\"role_pk\":\"" + treeNode.flag + "\",";
            sel_data_pk += "\"role_name\":\"" + treeNode.name + "\"}";
        }
        function hideNodes() {
            var zTree = $.fn.zTree.getZTreeObj("treeDemo"),
