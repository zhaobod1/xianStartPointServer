<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ad_add.aspx.cs" Inherits="info_driving_add" %>
        ...
        $(document).ready(function() {
            ...
            $("#btn_save").click(function() {
                ...
                $.ajax({
                    url: "getdata.aspx",
                    type: "post",
                    data: { com: "save_driving", p_id: $("#Select1").val(), c_id: $("#Select2").val(), area_id: $("#Select3").val(), driving_pk: $("#driving_pk").val(), driving_name: $("#driving_name").val(), driving_info: $("#driving_info").val(), driving_lat: $("#driving_lat").val(), driving_merge_count: $("#driving_merge_count").val(), c: new Date().getTime() },
                    dataType: "json",
                    error: function(err) {
