<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_add.aspx.cs" Inherits="sys_manage_admin_add" %>
...
<body>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input class="input" style="width: 150px;" id="Text71" type="text" />
                    </td>
                </tr>
                <tr>
                    <td style="background-color: #F4F2F3; text-align: right;">
                    ...
                    <td>
                        <input class="input" style=" display:none "id="Text8" type="text" />
                         <input class="input" style="width: 150px;"  id="Text81" type="text" />
                    </td>
                </tr>
                <tr>
                    <td style="background-color: #F4F2F3; text-align: right;">
                    ...
                    <td>
                        ...
                        <input class="input" style="width: 150px;" id="Text91" type="text" />
                    </td>
                </tr>
                <tr>
                    <td style="background-color: #F4F2F3; text-align: right;">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                        <input id="Radio1" value="0" name="user_lock" type="radio" />是&nbsp;&nbsp;
                        <input id="Radio2"  value="1" checked="checked" name="user_lock" type="radio" />否
                    </td>
                </tr>
            </table>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("#Text71").attr("readonly", "true").click(function() { sel_org(7); });
            $("#Text81").attr("readonly", "true").click(function() { sel_org(8); });
            $("#Text91").attr("readonly", "true").click(function() { sel_role(9); });
