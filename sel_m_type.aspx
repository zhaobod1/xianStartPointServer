<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sel_m_type.aspx.cs" Inherits="sel_m_type" %>
...
<body style="margin: 0; padding: 0;">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
           ...
           // $("table tr:eq(0)").height(pageHeight - 33 - 20);
            Bind();
            $("#btn_save").click(function() {
                if (sel_data_pk == "") { Popalert("请选择媒体形式！"); return false; }
                parent.set_m_type(sel_data_pk);
                parent.closePop();
            });
        ...
        function Bind() {
            ...
            $.ajax({
                ...
                type: "post",
                data: "com=search_sel_type&t="+ "<%=t %>" +"&c" + new Date().getTime(),
                dataType: "json",
                error: function(err) {
        ...
        function onClick(event, treeId, treeNode, clickFlag) {
            if (treeNode.u == "0") { $("a").removeClass("curSelectedNode"); return; }
            sel_data_pk = "{\"type_pk\":\"" + treeNode.flag + "\",";
            sel_data_pk += "\"type_name\":\"" + treeNode.name + "\"}";
        }
        function hideNodes() {
            var zTree = $.fn.zTree.getZTreeObj("treeDemo"),
