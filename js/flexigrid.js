...
(function($) {
    ...
    $.addFlex = function(t, p) {
        ...
        p = $.extend({
            ...
            sh_th: false //apply odd even stripes
        }, p);
					...
					(
						function() {
						    ...
						    if (pth != null) {
						        ...
						        $(tdDiv).css({ textAlign: $(this).attr("align"), width: $('div:first', pth)[0].style.width });
						...
						.hover(
							function() {
							    ...
							    if (g.colCopy) {
							        ...
							        $(g.nBtn).css({ height: g.bDiv.offsetTop });
			...
			(
			 	function() {
			 	    ...
			 	    if (kcol.style.display == 'none') chk = '';
			 	        ...
			 	        if ($("th[axis='col" + cn + "']", g.hDiv).attr("d") != "1")
