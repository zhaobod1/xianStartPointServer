<%@ Page Language="C#" AutoEventWireup="true" CodeFile="stat_student_count.aspx.cs" Inherits="stat_stat_student_count" %>
    ...
    <script type="text/javascript">
        ...
        function Bind() {
            ...
            $.ajax({
                url: "getdata.aspx",
                type: "post",
                data: "com=stat_student_count&stat=" + $("#Text1").val() + "&stat_sdate=" + $("#Text2").val() + "&stat_edate=" + $("#Text3").val() + "&student_state=" + $("#Text4").val() + "&c" + new Date().getTime(),
                dataType: "json",
                error: function(err) {
