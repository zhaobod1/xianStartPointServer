<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeFile="complain_look.aspx.cs"
    Inherits="message_complain_look" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#btn_save").click(function () {
                if (confirm("确定该投诉已处理吗？")) {                 
                    $.ajax({
                        url: "getdata.aspx",
                        type: "post",
                        data: "com=cog_info&info_type=1&cog_pk=" + "<%=edit_pk %>" + "&info_rem=" + $("#info_rem").val() + "&c=" + new Date().getTime(),
                        dataType: "json",
                        error: function (err) {
                ...
                $.ajax({
                    ...
                    success: function(da) {
                        if (da != null) {
                            ...
                            if (info.info_state == "1")
                            {
                                $("#btn_save").hide().parent().width(129);
                            }
